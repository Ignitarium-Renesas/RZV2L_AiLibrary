...
int8_t print_result(Image* img)
{
    ...
    if (ai_inf_prev != (uint32_t) ai_time)
    {
        ...
        img->write_string_rgb(str1, DRPAI_IN_WIDTH * RESIZE_SCALE + TEXT_WIDTH_OFFSET, LINE_HEIGHT+2*LINE_HEIGHT_OFFSET, CHAR_SCALE_SMALL, WHITE_DATA);
    }
