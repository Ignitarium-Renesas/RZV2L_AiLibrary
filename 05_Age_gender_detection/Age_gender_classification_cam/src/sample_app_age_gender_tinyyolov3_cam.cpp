...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : sample_app_age_gender_tinyyolov3_cam.cpp
* Version      : 7.20
* Description  : RZ/V2L DRP-AI Sample Application for Resnet34 with TinyYOLOv3 MIPI Camera version
***********************************************************************************************************************/
...
int32_t main(int32_t argc, char * argv[])
{
    ...
    printf("Model : Resnet34 with TinyYOLOv3 | fairface_cam, tinyyolov3_cam\n");
