...
******************************************/
const static std::string drpai_address_file = shv_path+"/"+drpai_prefix+"/"+drpai_prefix+"_addrmap_intm.txt";
const static std::string drpai_file_path[5] =
{
    shv_path+"/"+drpai_prefix+"/drp_desc.bin",
    shv_path+"/"+drpai_prefix+"/"+drpai_prefix+"_drpcfg.mem",
    shv_path+"/"+drpai_prefix+"/drp_param.bin",
    shv_path+"/"+drpai_prefix+"/aimac_desc.bin",
    shv_path+"/"+drpai_prefix+"/"+drpai_prefix+"_weight.dat",
};
