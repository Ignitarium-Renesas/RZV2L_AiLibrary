...
* File Name    : define.h
* Version      : 7.20
* Description  : RZ/V2L DRP-AI Sample Application for PyTorch ResNet18 Image version
***********************************************************************************************************************/
...
******************************************/
const static std::string label_list     = age_path+"/age_classes.txt";
const static std::string drpai_prefix   = "age_resnet18";
